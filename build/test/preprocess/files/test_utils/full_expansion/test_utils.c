...
# 2 "test/test_utils.c" 2
# 1 "include/utils.h" 1



int compute(int x);
# 3 "test/test_utils.c" 2
# 1 "build/test/mocks/test_utils/mock_main.h" 1
...
# 7 "build/test/mocks/test_utils/mock_main.h" 2
