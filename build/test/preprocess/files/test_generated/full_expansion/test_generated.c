# 0 "test/test_generated.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/test_generated.c"
...
# 2 "test/test_generated.c" 2
# 1 "build/test/mocks/test_generated/mock_main.h" 1
...
# 7 "build/test/mocks/test_generated/mock_main.h" 2
...
void add_CMockExpectAndReturn(UNITY_UINT cmock_line, int a, int b, int cmock_to_return);


void multiply_CMockExpectAndReturn(UNITY_UINT cmock_line, int a, int b, int cmock_to_return);
